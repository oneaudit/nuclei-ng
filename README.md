...
[form-detect] [http] [info] Found on 2 URLs ["http://wp.sec2/"] [/2025/02/14/bonjour-tout-le-monde/, /comments/]
[form-detect] [http] [info] Found on 1 URLs ["http://wp.sec2/wp-comments-post.php"] [/2025/02/14/bonjour-tout-le-monde/]
[form-detect] [http] [info] Found on 2 URLs ["http://wp.sec2/wp-login.php"] [/wp-login, /wp-login.php]
...
[cookie-detect] [http] [info] Found on 3 URLs ["wordpress_c9fd5a0c97d0e084fdf80980af45bd8b"] [/wp-login.php]
[cookie-detect] [http] [info] Found on 3 URLs ["wordpress_logged_in_c9fd5a0c97d0e084fdf80980af45bd8b"] [/wp-login.php]
[cookie-detect] [http] [info] Found on 3 URLs ["wordpress_sec_c9fd5a0c97d0e084fdf80980af45bd8b"] [/wp-login.php]
[cookie-detect] [http] [info] Found on 6 URLs ["wordpress_test_cookie"] [/wp-login, /wp-login.php]
[cookie-detect] [http] [info] Found on 3 URLs ["wordpresspass_c9fd5a0c97d0e084fdf80980af45bd8b"] [/wp-login.php]
[cookie-detect] [http] [info] Found on 3 URLs ["wordpressuser_c9fd5a0c97d0e084fdf80980af45bd8b"] [/wp-login.php]
[cookie-detect] [http] [info] Found on 3 URLs ["wp-postpass_c9fd5a0c97d0e084fdf80980af45bd8b"] [/wp-login.php]
[cookie-detect] [http] [info] Found on 3 URLs ["wp-settings-0"] [/wp-login.php]
[cookie-detect] [http] [info] Found on 3 URLs ["wp-settings-time-0"] [/wp-login.php]
[cookie-detect] [http] [info] Found on 2 URLs ["wp_lang"] [/wp-login, /wp-login.php]
[cookies-without-httponly] [javascript] [info] Found on 3 URLs ["wordpress_test_cookie"] [/wp-login.php]
[cookies-without-httponly] [javascript] [info] Found on 2 URLs ["wp_lang"] [/wp-login.php]
[cookies-without-secure] [javascript] [info] Found on 3 URLs ["wordpress_test_cookie"] [/wp-login.php]
[cookies-without-secure] [javascript] [info] Found on 2 URLs ["wp_lang"] [/wp-login]
[cors-detect:headers] [http] [info] Found on 14 URLs [/wp-admin/admin-ajax.php, /wp-json, /wp-json/, ...]
[cors-exploit:arbitrary-origin] [http] [info] Found on 13 URLs [header:Origin] [GET] [/wp-json, /wp-json/, /wp-json/my_namespace/, ...]
[email-detect] [http] [info] Found on 1 URLs ["quentin.ramsamy.cf@gmail.com"] [/.git/logs/HEAD]
[http-missing-security-headers:content-security-policy] [http] [info] Found on 91 URLs [/.git/, /.git/HEAD, /.git/config, ...]
[http-missing-security-headers:permissions-policy] [http] [info] Found on 91 URLs [/.git/, /.git/HEAD, /.git/config, ...]
[http-missing-security-headers:referrer-policy] [http] [info] Found on 91 URLs [/.git/, /.git/HEAD, /.git/config, ...]
[http-missing-security-headers:strict-transport-security] [http] [info] Found on 91 URLs [/.git/, /.git/HEAD, /.git/config, ...]
[http-missing-security-headers:x-content-type-options] [http] [info] Found on 78 URLs [/.git/, /.git/HEAD, /.git/config, ...]
[open-redirect-detect:parameters] [javascript] [info] Found on 1 URLs ["dir"]
[open-redirect-detect:parameters] [javascript] [info] Found on 1 URLs ["redirect_to"]
[open-redirect-detect:parameters] [javascript] [info] Found on 1 URLs ["url"]
[options-method-generic] [http] [info] Found on 46 URLs [/.git/, /.git/HEAD, /.git/config, ...]
[options-method-non-generic] [javascript] [info] Found on 35 URLs ["POST"] [undefined]
[options-method-non-generic] [javascript] [info] Found on 32 URLs ["TRACE"] [undefined]
[tech-detect:apache] [http] [info] Found on 95 URLs [/, /.git/, /.git/HEAD, ...]
[tech-detect:gravatar] [http] [info] Found on 1 URLs [/2025/02/14/bonjour-tout-le-monde/]
[tech-detect:php] [http] [info] Found on 63 URLs [/, /0/, /2025/, ...]
[tech-version:apache] [http] [info] Found on 95 URLs ["2.3.10"] [/, /.git/, /.git/HEAD, ...]
[tech-version:apache] [http] [info] Found on 95 URLs ["2.4.59"] [/, /.git/, /.git/HEAD, ...]
[tech-version:php] [http] [info] Found on 95 URLs ["8.3.6"] [/, /.git/, /.git/HEAD, ...]
