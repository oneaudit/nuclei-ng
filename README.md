...
[http-missing-security-headers:content-security-policy] [http] [info] Found on 24 URLs [/.git/, /.git/config, /2025/02/14/bonjour-tout-le-monde/feed/atom/, ...]
[http-missing-security-headers:permissions-policy] [http] [info] Found on 24 URLs [/.git/, /.git/config, /2025/02/14/bonjour-tout-le-monde/feed/atom/, ...]
[http-missing-security-headers:referrer-policy] [http] [info] Found on 24 URLs [/.git/, /.git/config, /2025/02/14/bonjour-tout-le-monde/feed/atom/, ...]
[http-missing-security-headers:strict-transport-security] [http] [info] Found on 24 URLs [/.git/, /.git/config, /2025/02/14/bonjour-tout-le-monde/feed/atom/, ...]
[http-missing-security-headers:x-content-type-options] [http] [info] Found on 24 URLs [/.git/, /.git/config, /2025/02/14/bonjour-tout-le-monde/feed/atom/, ...]
[known-403-page:apache] [http] [info] Found on 5 URLs [/:, /wp-admin/images/, /wp-content/themes/twentytwentyfive/assets/, ...]
[known-404-page:apache] [http] [info] Found on 2 URLs [/wp-json/, /wp-json/oembed/1.0/embed]
[known-404-page:wordpress] [http] [info] Found on 13 URLs [/.git/, /.git/HEAD, /.git/logs/, ...]
...
[options-method-generic] [http] [info] Found on 22 URLs [//xmlrpc.php, /LICENSE, /README, ...]
[options-method-non-generic] [javascript] [info] Found on 24 URLs ["POST"] [/wp-admin/css/forms.min.css]
[options-method-non-generic] [javascript] [info] Found on 22 URLs ["TRACE"] [/wp-admin/css/forms.min.css]
...
[tech-detect:apache] [http] [info] Found on 22 URLs [/.git/config, /.git/logs/HEAD, /1k/1j.1H, ...]
[tech-detect:php] [http] [info] Found on 14 URLs [/.git/config, /.git/logs/HEAD, /1k/1j.1H, ...]
[tech-version:apache] [http] [info] Found on 22 URLs ["2.4.59"] [/.git/, //, /////, ...]
[tech-version:cms] [http] [info] Found on 7 URLs ["WordPress 6.7.2"] [/.git/, //, /////, ...]
[tech-version:mod_fcgid] [http] [info] Found on 22 URLs ["2.3.10"] [/.git/, //, /////, ...]
[tech-version:os] [http] [info] Found on 22 URLs ["Win64"] [/.git/, //, /////, ...]
[tech-version:php] [http] [info] Found on 22 URLs ["8.3.6"] [/.git/, //, /////, ...]
...
[wordpress-debug-log] [http] [low] Found on 1 URLs ["7050146 bytes"] [/wp-content/debug.log]
...
[wordpress-xmlrpc:pingback] [http] [medium] Found on 4 URLs [//xmlrpc.php, /xmlrpc]
```
