...
[http-missing-security-headers:content-security-policy] [http] [info] Found on 64 URLs [/, /.git/, /.git/HEAD, ...]
...
[http-missing-security-headers:x-content-type-options] [http] [info] Found on 64 URLs [/, /.git/, /.git/HEAD, ...]
[known-403-page:apache] [http] [info] Found on 4 URLs [/wp-content/themes/twentytwentyfive/, /wp-content/themes/twentytwentyfive/assets/, /wp-content/themes/twentytwentyfive/assets/fonts/, /wp-content/themes/twentytwentyfive/assets/fonts/manrope/]
[known-403-page:custom] [http] [info] Found on 1 URLs [/wp-mail]
[known-404-page:apache] [http] [info] Found on 2 URLs [/wp-json/, /wp-json/oembed/1.0/embed]
[known-404-page:wordpress] [http] [info] Found on 12 URLs [/.git/HEAD, /.git/config, /.git/index, ...]
...
[options-method-generic] [http] [info] Found on 18 URLs [//xmlrpc.php, /LICENSE, /Readme, ...]
[options-method-non-generic] [javascript] [info] Found on 22 URLs ["POST"] [/wp-admin/images/images]
[options-method-non-generic] [javascript] [info] Found on 21 URLs ["TRACE"] [/wp-admin/images/images]
...
[tech-detect:apache] [http] [info] Found on 47 URLs [/, /.git/, /.git/logs/, ...]
[tech-detect:php] [http] [info] Found on 30 URLs [/, /.git/, /.git/logs/, ...]
[tech-version:apache] [http] [info] Found on 44 URLs ["2.4.59"] [/, /.git/logs/HEAD, //, ...]
[tech-version:cms] [http] [info] Found on 14 URLs ["WordPress 6.7.2"] [/, /.git/logs/HEAD, //, ...]
[tech-version:mod_fcgid] [http] [info] Found on 44 URLs ["2.3.10"] [/, /.git/logs/HEAD, //, ...]
[tech-version:os] [http] [info] Found on 44 URLs ["Win64"] [/, /.git/logs/HEAD, //, ...]
[tech-version:php] [http] [info] Found on 44 URLs ["8.3.6"] [/, /.git/logs/HEAD, //, ...]
...
[wordpress-debug-log] [http] [low] Found on 1 URLs ["8493881 bytes"] [/wp-content/debug.log]
