...
[http-missing-security-headers:content-security-policy] [http] [info] Found on 55 URLs [/, /.gitignore, //, ...]
[http-missing-security-headers:permissions-policy] [http] [info] Found on 55 URLs [/, /.gitignore, //, ...]
[http-missing-security-headers:referrer-policy] [http] [info] Found on 57 URLs [/, /.gitignore, //, ...]
[http-missing-security-headers:strict-transport-security] [http] [info] Found on 55 URLs [/, /.gitignore, //, ...]
[http-missing-security-headers:x-content-type-options] [http] [info] Found on 57 URLs [/, /.gitignore, //, ...]
[known-403-page:apache] [http] [info] Found on 5 URLs [/:, /wp-admin/css/, /wp-content/themes/twentytwentyfive/, ...]
[known-403-page:wordpress] [http] [info] Found on 1 URLs [/wp-mail.php]
[known-404-page:apache] [http] [info] Found on 2 URLs [//wp-json/oembed/1.0/embed, /wp-json/]
[known-404-page:wordpress] [http] [info] Found on 10 URLs [/1k/1j, /404/, /PAGENOTFOUND, ...]
[known-500-page:wordpress] [http] [info] Found on 2 URLs [/wp-config-sample.php, /wp-signup.php]
[license-file] [http] [info] Found on 2 URLs [/LICENSE, /LICENSE.txt]
[options-method-generic] [http] [info] Found on 28 URLs [//wp-admin/css/install.css, //xmlrpc.php, /LICENSE.txt, ...]
[options-method-non-generic] [javascript] [info] Found on 27 URLs ["POST"] [/Readme]
[options-method-non-generic] [javascript] [info] Found on 25 URLs ["TRACE"] [/Readme]
...
[stacktrace:php] [http] [low] Found on 2 URLs [/wp-settings, /wp-signup.php]
[tech-detect:apache] [http] [info] Found on 63 URLs [/, /.git/index, /.gitignore, ...]
[tech-detect:gravatar] [http] [info] Found on 2 URLs [/2025/02/14/bonjour-tout-le-monde/]
[tech-detect:php] [http] [info] Found on 37 URLs [/, /.git/index, /.gitignore, ...]
[tech-version:apache] [http] [info] Found on 64 URLs ["2.4.59"] [/, /.git/index, /.gitignore, ...]
[tech-version:cms] [http] [info] Found on 16 URLs ["WordPress 6.7.2"] [/, /.git/index, /.gitignore, ...]
[tech-version:mod_fcgid] [http] [info] Found on 64 URLs ["2.3.10"] [/, /.git/index, /.gitignore, ...]
[tech-version:os] [http] [info] Found on 62 URLs ["Win64"] [/, /.git/index, /.gitignore, ...]
[tech-version:php] [http] [info] Found on 64 URLs ["8.3.6"] [/, /.git/index, /.gitignore, ...]
