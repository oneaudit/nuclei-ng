...
```
  ...
  / __ \/ / / / ___/ / _ \/ /
 / / / / /_/ / /__/ /  __/ /
/_/ /_/\__,_/\___/_/\___/_/ ng  v1.0.9
...
[http-missing-security-headers:content-security-policy] [http] [info] Found on 34 URLs [/, /apache-v, /comment, ...]
[http-missing-security-headers:permissions-policy] [http] [info] Found on 34 URLs [/, /apache-v, /comment, ...]
